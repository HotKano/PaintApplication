...
public class PaintActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void connection() {
        String url = "http://jang.anymobi.kr/android/myinfo.php";
        ContentValues contentValues = new ContentValues();
        contentValues.put("name", "김종우");
        contentValues.put("age", 29);
        NetworkTask networkTask = new NetworkTask(url, contentValues, PaintActivity.this);
        // onPostExecute 에서 json 처리.
        networkTask.execute();
    }
